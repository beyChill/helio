...
def get_streamer():
    ...
    parser.add_argument("name", nargs="?", help=help_name, default="--capture")
...
def block_reason():
    ...
    parser.add_argument("streamer", nargs=1, help=help_name)
...
def cap_status():
    ...
    epilog = "name is the default and can be omitted"
    parser = Cmd2ArgumentParser(
        prog="hello", usage=usage, description=desc, epilog=epilog
    )
    parser.add_argument("sort", choices=["date", "name", "size"], help="Use one option")
